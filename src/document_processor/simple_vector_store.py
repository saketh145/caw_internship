...
class SimpleVectorStore:
    ...
    def query(self, query_embeddings: List[List[float]], n_results: int = 5, where: Dict[str, Any] = None, include: List[str] = None) -> Dict[str, List]:
    ...
    def get(self, ids: List[str] = None, where: Dict[str, Any] = None, limit: int = None, include: List[str] = None) -> Dict[str, List]:
